...
function table(arr, max){
  ...
  sisa > 0 ? teks += '\n' + equal(lengthMax, sisa) : teks += ''
  console.log(teks)
}



table([12, 79996, 7655, 777, 876, 8866, 97, 788, 89, 9, 888839, 8882, 88, 234, 234,4,23434,23423,3458932348787,345893234878734,234234,2342], 2)
